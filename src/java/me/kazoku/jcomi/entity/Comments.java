...
public class Comments implements DataAccessObject<Comment> {

    private JavaSQLClient client;
    private Connection connection;

    public Comments(JavaSQLClient client) {
        this.client = client;
    }

    @Override
    public int insert(Comment object) throws SQLException {
        String sql = "INSERT INTO [Comment] (Comic_ID, Account_ID, Content, Post_Date) VALUES (?, ?, ?, ?)";
